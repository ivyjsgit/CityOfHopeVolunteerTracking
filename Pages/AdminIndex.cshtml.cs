        ...
        public FileStreamResult OnPostView()
        {
            ...
            for (int i = 1; i < 13; i++)
            {
                ...
                foreach (var volunteerActivity in volunteerActivities)
                {
                    ...
                    if (DateTime.Now.Year == volunteerActivity.StartTime.Year)
                    {
                ...
                worksheet.Range["B" + (i + 15)].Text = staffHours.ToString();
                worksheet.Range["C" + (i + 15)].Text = (staffHours * valueOfHour.Value).ToString();
                worksheet.Range["D" + (i + 15)].Text = volunteerHours.ToString();
                worksheet.Range["E" + (i + 15)].Text = (volunteerHours * valueOfHour.Value).ToString();
                worksheet.Range["F" + (i + 15)].Text = (staffHours + volunteerHours).ToString();
                worksheet.Range["G" + (i + 15)].Text = ((staffHours + volunteerHours) * valueOfHour.Value).ToString();
